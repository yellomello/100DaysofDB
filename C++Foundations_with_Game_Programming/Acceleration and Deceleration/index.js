...
var ASM_CONSTS = {
  92864: () => { if (document.fullscreenElement) return 1; },  
 92910: () => { return document.getElementById('canvas').width; },  
 92962: () => { return parseInt(document.getElementById('canvas').style.width); },  
 93030: () => { document.exitFullscreen(); },  
 93057: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 93130: () => { if (document.fullscreenElement) return 1; },  
 93176: () => { return document.getElementById('canvas').width; },  
 93228: () => { return screen.width; },  
 93253: () => { document.exitFullscreen(); },  
 93280: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93413: () => { return window.innerWidth; },  
 93439: () => { return window.innerHeight; },  
 93466: () => { if (document.fullscreenElement) return 1; },  
 93512: () => { return document.getElementById('canvas').width; },  
 93564: () => { return parseInt(document.getElementById('canvas').style.width); },  
 93632: () => { if (document.fullscreenElement) return 1; },  
 93678: () => { return document.getElementById('canvas').width; },  
 93730: () => { return screen.width; },  
 93755: () => { return window.innerWidth; },  
 93781: () => { return window.innerHeight; },  
 93808: () => { if (document.fullscreenElement) return 1; },  
 93854: () => { return document.getElementById('canvas').width; },  
 93906: () => { return screen.width; },  
 93931: () => { document.exitFullscreen(); },  
 93958: () => { if (document.fullscreenElement) return 1; },  
 94004: () => { return document.getElementById('canvas').width; },  
 94056: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94124: () => { document.exitFullscreen(); },  
 94151: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 94209: () => { return screen.width; },  
 94234: () => { return screen.height; },  
 94260: () => { return window.screenX; },  
 94287: () => { return window.screenY; },  
 94314: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94367: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 94438: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 94495: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94751: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 94822: () => { if (document.fullscreenElement) return 1; },  
 94868: () => { return window.innerWidth; },  
 94894: () => { return window.innerHeight; },  
 94921: () => { if (document.pointerLockElement) return 1; }
};
