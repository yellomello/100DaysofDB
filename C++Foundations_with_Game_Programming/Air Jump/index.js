...
var ASM_CONSTS = {
  92896: () => { if (document.fullscreenElement) return 1; },  
 92942: () => { return document.getElementById('canvas').width; },  
 92994: () => { return parseInt(document.getElementById('canvas').style.width); },  
 93062: () => { document.exitFullscreen(); },  
 93089: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 93162: () => { if (document.fullscreenElement) return 1; },  
 93208: () => { return document.getElementById('canvas').width; },  
 93260: () => { return screen.width; },  
 93285: () => { document.exitFullscreen(); },  
 93312: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93445: () => { return window.innerWidth; },  
 93471: () => { return window.innerHeight; },  
 93498: () => { if (document.fullscreenElement) return 1; },  
 93544: () => { return document.getElementById('canvas').width; },  
 93596: () => { return parseInt(document.getElementById('canvas').style.width); },  
 93664: () => { if (document.fullscreenElement) return 1; },  
 93710: () => { return document.getElementById('canvas').width; },  
 93762: () => { return screen.width; },  
 93787: () => { return window.innerWidth; },  
 93813: () => { return window.innerHeight; },  
 93840: () => { if (document.fullscreenElement) return 1; },  
 93886: () => { return document.getElementById('canvas').width; },  
 93938: () => { return screen.width; },  
 93963: () => { document.exitFullscreen(); },  
 93990: () => { if (document.fullscreenElement) return 1; },  
 94036: () => { return document.getElementById('canvas').width; },  
 94088: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94156: () => { document.exitFullscreen(); },  
 94183: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 94241: () => { return screen.width; },  
 94266: () => { return screen.height; },  
 94292: () => { return window.screenX; },  
 94319: () => { return window.screenY; },  
 94346: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94399: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 94470: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 94527: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94783: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 94854: () => { if (document.fullscreenElement) return 1; },  
 94900: () => { return window.innerWidth; },  
 94926: () => { return window.innerHeight; },  
 94953: () => { if (document.pointerLockElement) return 1; }
};
