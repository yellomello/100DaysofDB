...
// include: C:\Users\hanse\AppData\Local\Temp\tmpboimrebg.js
...
Module['FS_createPath']("/", "textures", true, true);
    ...
    loadPackage({"files": [{"filename": "/highscore.txt", "start": 0, "end": 1}, {"filename": "/textures/12_nebula_spritesheet.png", "start": 1, "end": 153166}, {"filename": "/textures/back-buildings.png", "start": 153166, "end": 160360}, {"filename": "/textures/far-buildings.png", "start": 160360, "end": 167123}, {"filename": "/textures/foreground.png", "start": 167123, "end": 182392}, {"filename": "/textures/scarfy.png", "start": 182392, "end": 192786}], "remote_package_size": 192786});

  })();

// end include: C:\Users\hanse\AppData\Local\Temp\tmpboimrebg.js
// include: C:\Users\hanse\AppData\Local\Temp\tmpfc72jw_n.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\hanse\AppData\Local\Temp\tmpfc72jw_n.js
// include: C:\Users\hanse\AppData\Local\Temp\tmp304fyy2k.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\hanse\AppData\Local\Temp\tmp304fyy2k.js
...
var ASM_CONSTS = {
  110768: () => { if (document.fullscreenElement) return 1; },  
 110814: () => { return document.getElementById('canvas').width; },  
 110866: () => { return parseInt(document.getElementById('canvas').style.width); },  
 110934: () => { document.exitFullscreen(); },  
 110961: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 111034: () => { if (document.fullscreenElement) return 1; },  
 111080: () => { return document.getElementById('canvas').width; },  
 111132: () => { return screen.width; },  
 111157: () => { document.exitFullscreen(); },  
 111184: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 111317: () => { return window.innerWidth; },  
 111343: () => { return window.innerHeight; },  
 111370: () => { if (document.fullscreenElement) return 1; },  
 111416: () => { return document.getElementById('canvas').width; },  
 111468: () => { return parseInt(document.getElementById('canvas').style.width); },  
 111536: () => { if (document.fullscreenElement) return 1; },  
 111582: () => { return document.getElementById('canvas').width; },  
 111634: () => { return screen.width; },  
 111659: () => { return window.innerWidth; },  
 111685: () => { return window.innerHeight; },  
 111712: () => { if (document.fullscreenElement) return 1; },  
 111758: () => { return document.getElementById('canvas').width; },  
 111810: () => { return screen.width; },  
 111835: () => { document.exitFullscreen(); },  
 111862: () => { if (document.fullscreenElement) return 1; },  
 111908: () => { return document.getElementById('canvas').width; },  
 111960: () => { return parseInt(document.getElementById('canvas').style.width); },  
 112028: () => { document.exitFullscreen(); },  
 112055: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 112113: () => { return screen.width; },  
 112138: () => { return screen.height; },  
 112164: () => { return window.screenX; },  
 112191: () => { return window.screenY; },  
 112218: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 112271: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 112342: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 112399: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 112655: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 112726: () => { if (document.fullscreenElement) return 1; },  
 112772: () => { return window.innerWidth; },  
 112798: () => { return window.innerHeight; },  
 112825: () => { if (document.pointerLockElement) return 1; }
};
