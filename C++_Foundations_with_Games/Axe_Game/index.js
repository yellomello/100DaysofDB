...
var ASM_CONSTS = {
  92712: () => { if (document.fullscreenElement) return 1; },  
 92758: () => { return Module.canvas.width; },  
 92790: () => { return parseInt(Module.canvas.style.width); },  
 92838: () => { document.exitFullscreen(); },  
 92865: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 92938: () => { if (document.fullscreenElement) return 1; },  
 92984: () => { return Module.canvas.width; },  
 93016: () => { return screen.width; },  
 93041: () => { document.exitFullscreen(); },  
 93068: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93201: () => { return window.innerWidth; },  
 93227: () => { return window.innerHeight; },  
 93254: () => { if (document.fullscreenElement) return 1; },  
 93300: () => { return Module.canvas.width; },  
 93332: () => { return parseInt(Module.canvas.style.width); },  
 ...
 93582: () => { return Module.canvas.width; },  
 93614: () => { return screen.width; },  
 93639: () => { document.exitFullscreen(); },  
 93666: () => { if (document.fullscreenElement) return 1; },  
 93712: () => { return Module.canvas.width; },  
 93744: () => { return parseInt(Module.canvas.style.width); },  
 93792: () => { document.exitFullscreen(); },  
 93819: ($0) => { Module.canvas.style.opacity = $0; },  
 93857: () => { return screen.width; },  
 93882: () => { return screen.height; },  
 93908: () => { return window.screenX; },  
 93935: () => { return window.screenY; },  
 93962: () => { return window.devicePixelRatio; },  
 93998: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94051: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94102: () => { Module.canvas.style.cursor = 'none'; },  
 94139: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94395: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94446: () => { if (document.pointerLockElement) return 1; },  
 94493: () => { if (document.fullscreenElement) return 1; },  
 94539: () => { return window.innerWidth; },  
 94565: () => { return window.innerHeight; }
};
